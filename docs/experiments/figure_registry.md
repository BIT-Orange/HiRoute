...
| `fig_state_scaling` | `Evaluation-E` | `results/aggregate/state_scaling_summary.csv` | `exp_scaling_v1` | `runs/registry/promoted_runs.csv` filtered by `exp_scaling_v1` | pending official runs |
| `fig_robustness` | `Evaluation-F` | `results/aggregate/robustness_summary.csv` | `exp_staleness_v1` + `exp_failures_v1` | promoted staleness/failure runs | pending official runs |
| `fig_ablation` | `Evaluation-G` | `results/aggregate/ablation_summary.csv` | `exp_main_v1` | `runs/registry/promoted_runs.csv` filtered by `exp_main_v1` | ready with current pipeline |
